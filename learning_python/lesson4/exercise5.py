...
Try to use re.DOTALL in your pattern search. Your search pattern should not include
any of the literal characters in the IPv6 address.

Create a list of IPv6 addresses that includes only the above two addresses.
